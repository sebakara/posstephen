...
<div class="form-group">
        {!! Form::label('tin', __('business.tin') . ':*') !!}
        <div class="input-group">
            <span class="input-group-addon">
                <i class="fa fa-suitcase"></i>
            </span>
            {!! Form::text('tax_number_1', null, ['class' => 'form-control', 'id'=>'tin', 'placeholder' => __('business.tin'), 'required']) !!}
            <!-- {!! Form::text('tax_number_1', null, ['class' => 'form-control', 'id'=>'tin', 'placeholder' => __('business.tin'), 'required']) !!} -->
        </div>
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        {!! Form::label('time_zone', __('business.mrc') . ':*') !!}
        <div class="input-group">
            <span class="input-group-addon">
                <i class="fas fa-clock"></i>
            </span>
            {!! Form::text('time_zone', null, ['class' => 'form-control', 'placeholder' => __('business.mrc'), 'required']) !!}
